...
<head>
    ...
    <style>
        ...
        nav a {
            ...
            text-align: center;
            margin-right: 100px; /* Added margin-right to space out links */
        }
        nav a:hover {
        ...
        .hero {
            background: url('images/Fact4.jpg') no-repeat center center/cover;
...
<body>
    <nav>
        ...
        <div>
            <a href="new1">ALL INFORMATION OF CUSTOMER</a>
